...
export const getRandomInteger = (min, max, randomFn = Math.random) => Math.floor(randomFn() * (max - min + 1) + min);
...
export const photoCollection = Array.from({length: COUNT_PHOTOS}, () => createPhotoInfo());
